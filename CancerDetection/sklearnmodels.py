...
if __name__ == '__main__':
	...
	for treenum in trees:
		clflist = [RandomForestClassifier(n_estimators=treenum), AdaBoostClassifier(n_estimators = treenum), tree.DecisionTreeClassifier(random_state = 1)]
	...
	data_df.to_csv('data/results/casestudy2a.csv')
	...
	print(data_df)
	# write data to file
	data_df.to_csv('data/results/casestudy3a.csv')
	...
	data_df.to_csv('data/results/casestudy4a.csv')
	...
	data_df.to_csv('data/results/casestudy5a.csv')
	...
	data_df.to_csv('data/results/casestudy6a.csv')
